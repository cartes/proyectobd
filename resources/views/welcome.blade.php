        ...
        <div class="relative z-10 py-28 container mx-auto px-6">
            ...
            <div class="text-center mb-100 hiw-reveal">
                ...
                <h2 class="text-4xl md:text-6xl font-black mb-6 leading-tight">
                    <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">Desbloquea</span>
            ...
            <!-- Steps Grid -->
            <div class="grid grid-cols-1 md:grid-cols-3 mt-100 gap-8 max-w-6xl mx-auto items-start">

                <!-- Step 1 -->
                <div class="hiw-reveal hiw-card group relative" style="--hiw-delay:0ms">
                    <div
                        class="absolute -inset-px rounded-3xl bg-gradient-to-b from-pink-500/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                    </div>
                    <div
                        class="relative h-full bg-slate-900/70 backdrop-blur-xl p-10 rounded-3xl border border-slate-700/60 group-hover:border-pink-500/60 transition-all duration-500">
                        <span
                            class="absolute top-5 right-7 text-8xl font-black text-pink-500/8 select-none leading-none">01</span>
                        <div
                            class="w-20 h-20 rounded-2xl bg-gradient-to-br from-pink-500 to-pink-700 flex items-center justify-center text-4xl mb-8 shadow-xl shadow-pink-500/30 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                            📝</div>
                        <h3 class="text-2xl font-bold mb-4">Crea tu Perfil VIP</h3>
                        <p class="text-slate-400 leading-relaxed text-sm">Sube tus mejores fotos y define qué buscas
                            con claridad. Sé directo y auténtico — tu perfil es tu carta de presentación al mundo de
                            élite.</p>
                        <div
                            class="mt-8 h-px bg-gradient-to-r from-pink-500 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left rounded-full">
                        </div>
                    </div>
                </div>
                ...
                <div class="hiw-reveal hiw-card group relative md:-mt-6" style="--hiw-delay:120ms">
                    ...
                    <div
                        class="absolute -top-4 z-40 left-1/2 -translate-x-1/2 whitespace-nowrap bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-bold px-5 py-1.5 rounded-full shadow-lg shadow-purple-500/40">
                        ⭐ Paso Clave
                    </div>
                    <div
                        class="relative h-full bg-slate-900/80 backdrop-blur-xl p-10 rounded-3xl border border-purple-500/50">
                        <span
                            class="absolute top-5 right-7 text-8xl font-black text-purple-500/8 select-none leading-none">02</span>
                        <div
                            class="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-4xl mb-8 shadow-xl shadow-purple-500/30 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                            🔍</div>
                        <h3 class="text-2xl font-bold mb-4">Descubre la Elite</h3>
                        <p class="text-slate-400 leading-relaxed text-sm">Usa nuestros filtros premium para encontrar
                            personas exitosas en tu ciudad o en toda Latinoamérica. Total discreción garantizada.</p>
                ...
                <div class="hiw-reveal hiw-card group relative" style="--hiw-delay:240ms">
                    <div
                        class="absolute -inset-px rounded-3xl bg-gradient-to-b from-indigo-500/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                    </div>
                    <div
                        class="relative h-full bg-slate-900/70 backdrop-blur-xl p-10 rounded-3xl border border-slate-700/60 group-hover:border-indigo-500/60 transition-all duration-500">
                        <span
                            class="absolute top-5 right-7 text-8xl font-black text-indigo-500/8 select-none leading-none">03</span>
                        <div
                            class="w-20 h-20 rounded-2xl bg-gradient-to-br from-indigo-500 to-blue-700 flex items-center justify-center text-4xl mb-8 shadow-xl shadow-indigo-500/30 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                            🥂</div>
                        <h3 class="text-2xl font-bold mb-4">Vive la Experiencia</h3>
                        <p class="text-slate-400 leading-relaxed text-sm">Conecta, chatea y acuerda esa primera cita
                            soñada. Cenas exclusivas, viajes de lujo o simplemente la mejor compañía de tu vida.</p>
                        <div
                            class="mt-8 h-px bg-gradient-to-r from-indigo-500 to-transparent scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left rounded-full">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mt-24 hiw-reveal" style="--hiw-delay:360ms">
                <p class="text-slate-400 mb-6 text-base tracking-wide uppercase text-xs font-semibold">¿Listo para
                    comenzar?</p>
                <a href="{{ route('register') }}"
        ...
        (function() {
            ...
            function init() {
                ...
                const shapeDefs = [{
                    ...
                    {
                        geo: new THREE.TorusGeometry(2.2, 0.4, 8, 32),
                        color: 0xa855f7,
                        x: 14,
                        y: 7,
                        z: -9,
                    ...
                    {
                        geo: new THREE.TorusGeometry(1.3, 0.3, 8, 20),
                        color: 0xec4899,
                        x: -19,
                        y: -2,
                        z: -7,
                    ...
                    {
                        geo: new THREE.TorusGeometry(0.9, 0.25, 6, 18),
                        color: 0x6366f1,
                        x: -5,
                        y: 8,
                        z: -8,
                ...
                const shapes = shapeDefs.map(d => {
                    ...
                    mesh.userData = {
                        rs: d.rs,
                        iy: d.y,
                        fs: 0.4 + Math.random() * 0.6,
                        fa: 0.4 + Math.random() * 0.6
                    };
                    scene.add(mesh);
                    return mesh;
                });
