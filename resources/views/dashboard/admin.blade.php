            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ App\Models\User::where('is_premium', true)->count() }}</p>
                    </div>
                </div>
                <div class="mt-4">
                    <span class="text-green-600 text-sm font-medium">
                        +{{ App\Models\User::where('is_premium', true)->where('created_at', '>=', now()->startOfMonth())->count() }} este mes
                    </span>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">${{ number_format(App\Models\User::where('is_premium', true)->count() * 29.99, 2) }}</p>
                    </div>
                </div>
                <div class="mt-4">
                    ...
                    <div class="space-y-4">
                        ...
                        @forelse($newUsers as $user)
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm text-gray-900">Nuevo usuario registrado: <span class="font-medium">{{ $user->name }}</span></p>
                        ...
                        @forelse($pendingReports as $report)
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm text-gray-900">Reporte de usuario: <span class="font-medium">{{ ucfirst(str_replace('_', ' ', $report->reason)) }}</span></p>
                        ...
                        @if($newPremium)
                            <div class="flex items-start space-x-3">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm text-gray-900">Nueva suscripción premium: <span class="font-medium">{{ $newPremium->name }}</span></p>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-2 gap-4">
                        <a href="{{ route('admin.moderation.reports') }}" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <a href="{{ route('admin.moderation.users') }}" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <a href="{{ route('admin.moderation.blocked-words') }}" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <a href="{{ route('admin.moderation.dashboard') }}" class="flex flex-col items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
