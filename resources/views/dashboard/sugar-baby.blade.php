            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow mb-6">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <!-- Add Photos -->
                            <a href="{{ route('profile.edit') }}" class="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer transition-colors">
                            ...
                            @else
                                <div class="flex items-center space-x-3 p-3 border border-green-200 rounded-lg bg-green-50">
                                    <div class="flex-shrink-0">
                                        <div class="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                ...
                <div class="bg-gradient-to-r from-amber-400 to-amber-500 rounded-lg p-6 text-white">
                    <div class="text-center">
                        ...
                        <button class="bg-white text-amber-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-amber-50 w-full">
                            Upgrade
                        </button>
                    </div>
                </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                        ...
                        <a href="{{ route('discover.index') }}" class="text-pink-600 text-sm font-medium hover:text-pink-800">Ver más</a>
                    </div>
                    <div class="p-6">
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    <div class="flex items-start space-x-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm text-gray-600">{{ $daddy->age }} años • {{ $daddy->city }}</p>
                                            <p class="text-xs text-gray-500 mt-1 line-clamp-2">{{ $daddy->bio }}</p>
                                            @if($daddy->is_verified)
                                                <span class="text-xs bg-green-100 text-green-800 px-2 py-0.5 rounded-full inline-block mt-2">✅ Verificado</span>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="flex space-x-2 mt-4">
                                        <a href="{{ route('profile.show', $daddy) }}" class="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-3 rounded-md text-sm font-medium transition-colors">
                                            Ver Perfil
                                        </a>
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                        ...
                        <a href="{{ route('chat.index') }}" class="text-pink-600 text-sm font-medium hover:text-pink-800">Ver todas</a>
                    </div>
                    <div class="p-6">
                        <div class="space-y-4">
                            @forelse($recentMessages as $message)
                                ...
                                @endphp
                                <a href="{{ route('chat.show', $message->conversation) }}" class="flex items-start space-x-4 p-3 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors">
                                    <div class="flex-shrink-0 relative">
                                        <x-user-avatar :user="$sender" size="md" />
                                        @if($sender->is_active)
                                            <div class="w-3 h-3 bg-green-400 border-2 border-white rounded-full absolute -mt-3 ml-9"></div>
                                        @endif
                                    </div>
