<div class="space-y-1">
    <!-- Dashboard -->
    <a href="{{ route('dashboard') }}" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md {{ request()->routeIs('dashboard') ? 'bg-red-100 text-red-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
    ...
    <a href="#" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
        ...
        Todos los Usuarios
        <span class="ml-auto bg-gray-100 text-gray-600 text-xs px-2 py-0.5 rounded-full">247</span>
    </a>
    ...
    <a href="#" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
        ...
        Sugar Daddies
        <span class="ml-auto bg-purple-100 text-purple-600 text-xs px-2 py-0.5 rounded-full">89</span>
    </a>
    ...
    <a href="#" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
        ...
        Sugar Babies
        <span class="ml-auto bg-pink-100 text-pink-600 text-xs px-2 py-0.5 rounded-full">158</span>
    </a>
    ...
    <a href="#" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
        ...
        <span class="ml-auto bg-yellow-100 text-yellow-600 text-xs px-2 py-0.5 rounded-full">12</span>
    </a>
    ...
    <a href="#" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
        ...
        Moderación de Fotos
        <span class="ml-auto bg-orange-100 text-orange-600 text-xs px-2 py-0.5 rounded-full">3</span>
    </a>
    ...
    <a href="#" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
        ...
        <span class="ml-auto bg-gray-100 text-gray-600 text-xs px-2 py-0.5 rounded-full">7</span>
    </a>
    ...
    <a href="#" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-50 hover:text-gray-900">
        ...
        <span class="ml-auto bg-green-100 text-green-600 text-xs px-2 py-0.5 rounded-full">45</span>
    </a>
