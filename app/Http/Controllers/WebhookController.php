    ...
    public function handleMercadoPagoWebhook(Request $request)
    {
        try {
            ...
            if (! $xSignature || ! $xRequestId) {
                Log::warning('Mercado Pago webhook missing signature header or request ID', [
            ...
            $isValid = $this->mpService->validateSignature($xSignature, $xRequestId, $resourceId, $payload);
